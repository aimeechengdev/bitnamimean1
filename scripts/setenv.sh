...
export PATH
LD_LIBRARY_PATH="/opt/bitnami/git/lib:/opt/bitnami/mongodb/lib:/opt/bitnami/sqlite/lib:/opt/bitnami/python/lib:/opt/bitnami/apache2/lib:/opt/bitnami/common/lib:$LD_LIBRARY_PATH"
