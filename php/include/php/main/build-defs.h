...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/opt/bitnami/php' '--enable-fpm' '--with-fpm-user=daemon' '--with-fpm-group=daemon' '--with-apxs2=/opt/bitnami/apache2/bin/apxs' '--with-expat-dir=/opt/bitnami/common' '--with-zlib-dir=/opt/bitnami/common' '--enable-mbstring=all' '--enable-soap' '--enable-bcmath' '--enable-ftp' '--with-xmlrpc' '--enable-fastcgi' '--enable-force-cgi-redirect' '--enable-cgi' '--with-imap=/bitnami/meanstack-linux-x64/src/imap-2007f' '--with-imap-ssl=/opt/bitnami/common' '--with-png-dir=/opt/bitnami/common' '--with-gd' '--with-zlib' '--with-curl=/opt/bitnami/common' '--with-jpeg-dir=/opt/bitnami/common' '--enable-exif' '--with-openssl=/opt/bitnami/common' '--with-ldap=/opt/bitnami/common' '--with-freetype-dir=/opt/bitnami/common' '--enable-calendar' '--enable-ctype' '--enable-pcntl' '--enable-session' '--with-regex=php' '--enable-spl' '--enable-zip' '--with-bz2=/opt/bitnami/common' '--enable-sockets' '--with-gmp=/opt/bitnami/common' '--with-mcrypt=/opt/bitnami/common' '--with-icu-dir=/opt/bitnami/common' '--with-tidy=/opt/bitnami/common' '--with-mysql=mysqlnd' '--with-mysqli=mysqlnd' '--with-pdo-mysql=mysqlnd' '--with-pdo_sqlite=/bitnami/meanstack-linux-x64/output/sqlite' '--with-sqlite3=/bitnami/meanstack-linux-x64/output/sqlite' '--with-iconv=/opt/bitnami/common' '--with-libxml-dir=/opt/bitnami/common' '--with-xsl=/opt/bitnami/common' '--with-dom=/opt/bitnami/common' '--with-gettext' '--enable-intl' '--with-readline=/opt/bitnami/common'"
...
#define PHP_IFX_LIBS		""
#define PHP_INSTALL_IT		"$(mkinstalldirs) '$(INSTALL_ROOT)/opt/bitnami/apache2/modules' &&                 $(mkinstalldirs) '$(INSTALL_ROOT)/opt/bitnami/apache2/conf' &&                  /opt/bitnami/apache2/bin/apxs -S LIBEXECDIR='$(INSTALL_ROOT)/opt/bitnami/apache2/modules'                        -S SYSCONFDIR='$(INSTALL_ROOT)/opt/bitnami/apache2/conf'                        -i -a -n php5 libphp5.la"
