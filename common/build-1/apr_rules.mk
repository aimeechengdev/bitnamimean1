...
#
apr_builddir=/bitnami/meanstack-linux-x64/output/common/build-1
apr_builders=/bitnami/meanstack-linux-x64/output/common/build-1
top_builddir=/bitnami/meanstack-linux-x64/output/common/build-1
...
#
CFLAGS=-I/bitnami/meanstack-linux-x64/output/common/include -fPIC -m64
CPPFLAGS=-I/bitnami/meanstack-linux-x64/output/common/include -I/bitnami/meanstack-linux-x64/output/sqlite/include -I/bitnami/meanstack-linux-x64/output/common/include/sasl -I/bitnami/meanstack-linux-x64/output/common/include
LDFLAGS=-L/bitnami/meanstack-linux-x64/output/sqlite/lib -L/bitnami/meanstack-linux-x64/output/common/lib -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
